...
@section('content')
    <div class="container pt-8 pb-32 px-8">
        ...
        <p>
            These Terms of Use constitute a legally binding agreement made between <u>you</u>, whether personally or on
            behalf
            of an entity (“you”) and <u>4 Thirteen Group SDN BHD</u> ("Company", “we”, “us”, or “our”), concerning your
            access
            to and use of the tinynote.io website as well as any other media form, media channel, mobile website or
            mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree
            that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use.
        </p>

        <p>
            Supplemental terms and conditions or documents that may be posted on the Site from time to time are hereby
            expressly incorporated herein by reference. We reserve the right, to make changes or
        ...
        <p>
            ...
            with these Terms of Use; (2) you will not access the Site through automated or non-human means, whether
            through a bot, script, or otherwise; (3) you will not use the Site for any illegal or unauthorized purpose;
        ...
        <p>
            ...
            THE LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US. CERTAIN STATE LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED
        ...
        <p>
            ...
            contact us at talktome@4thirteen.com.my.
        </p>

        <p>
            When you visit us and use our services, you trust us with your personal information. We take your privacy
            very seriously. In this privacy policy, we seek to explain to you in the clearest way possible what
            ...
            not agree with, please discontinue use of our and our services.
        </p>
        ...
        <p>
            ...
            interest in using our products and services.
        </p>

        <p>
            The personal information that we collect depends on the context of your interactions with us and the choices
        ...
        <p>
            Our offer you the ability to register and login using your third party social media account details (like
            your
            ...
            provider concerned, but will often include your name, e-mail address, friends list, profile picture as well
            as
        ...
        <p>
            ...
            third
            party social media provider. We recommend that you review their privacy policy to understand how they
            collect,
            use and share your personal information, and how you can set your privacy preferences on their sites and
            apps.
        </p>
        ...
        <p>
            Our servers are located in the US. If you are accessing our from outside, please be aware that your
        ...
        <p>
            The may contain advertisements from third parties that are not affiliated with us and which may link to
        ...
        <p>
            We will only keep your personal information for as long as you have an account on our website. Once you
            deleted your account we will either delete or anonymize it, or, if this is not possible (for example,
        ...
        <h2>DO WE MAKE ANY UPDATES TO THIS POLICY?</h2>
        ...
        <p>
            If you have questions or comments about this policy, you may email us at talktome@4thirteen.com.my.
        </p>
    </div>
@stop
