...
@section('description', 'Tiny Note is a an Online Design Collaboration Tool that lets you upload visuals, invite your clients, and get design annotated feedback instantly.')

@section('main')
    <div class="relative bg-blue-100">
        @include('partials.header')

        <div class="px-8 py-4" id="start-3">
            <div class="title container items-center text-center">
                <h1 class="text-3xl md:text-4xl lg:text-6xl font-bold max-w-2xl mx-auto pt-16" style="line-height:1">
                    An Online Design Collaboration Tool!
                </h1>
    ...
    <div class="bg-white py-4 mt-16">
        <div class="container px-10">
            <h2 class="text-2xl md:text-3xl font-bold max-w-3xl mx-auto md:pt-8 text-center">
                Tiny Note is an Online Design Collaboration Tool.<br>
                You'll get your design annotated feedback in only <strong>three steps</strong>.
            </h2>
        </div>
    </div>
